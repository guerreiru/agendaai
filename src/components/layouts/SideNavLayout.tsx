        ...
        <div>
          ...
          <nav aria-label={title} className="flex flex-col gap-2 px-4">
                ...
                <NavLink
                  className={({ isActive }) =>
                    [
                      ...
                      isActive
                        ? "bg-lime-300 text-slate-900 hover:bg-lime-200 font-medium shadow-sm"
                        : "bg-white/10 text-slate-400 hover:bg-slate-100 hover:text-slate-900 font-medium",
                    ].join(" ")
                  }
                  key={item.label}
                  to={item.to}
            ...
            <Button
              ...
              className="flex justify-start items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-300 hover:text-slate-900 hover:bg-slate-100"
              type="button"
            >
